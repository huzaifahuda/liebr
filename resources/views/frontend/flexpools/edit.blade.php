    ...
    <div class="container m-5" style="height: 90vh;">
        ...
        <div class="row py-5 px-5" style="background: #fff;  margin: 20px 164px">
            <div class="col-md-12 px-5">
                ...
                <form action="{{route('flexpools.update', base64_encode($flexpools->id))}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" name="category_id" aria-label="Default select example">
                                ...
                                <option {{$data->id == $flexpools->category_id ? 'selected' : ''}} value="{{$data->id}}">{{$data->title}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="flexpoolname" value="{{$flexpools->flexpoolname}}" class="form-control" id="inputPassword">
                        </div>
                    </div>
                    <div class="d-grid gap-2">
                        <button class="btn btn-custom" type="submit">Update Flexpool</button>
                    </div>
                </form>
